...
from app.views.user import CreateUser,UpdateUser,DestroyUser,LoginUserView,RetrieveUser
from app.views.post import CreatePost,RetrievePost,UpdatePost,DestroyPost,RetrieveUserPosts,LikePost,CommentPost,FollowUser
...
urlpatterns = [
    ...
    path('post/comment/', CommentPost.as_view()),

...
from app.serializers import PostSerializer, PostLikeSerializer, CommentSerializer, UserFollowSerializer
...
class CommentPost(APIView):
    ...
    def get(self, request):
        try:
            comments = PostComment.objects.filter(user=request.user)
            
            if not comments:
                return Response({ "success": False, "comments": "You made no comments" })
